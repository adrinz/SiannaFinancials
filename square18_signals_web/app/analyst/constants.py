...
TICKERS: list[dict] = [
    ...
    {"symbol": "SPCX",  "name": "SpaceX",                  "sector": "Aerospace / Space Tech",   "bias":  0.08},
...
DEFAULT_IV: dict[str, float] = {
    ...
    "AAPL": 0.24,  "PANW": 0.36, "SPY":  0.15, "SPCX": 0.75, "QQQ":  0.18,
...
ANCHOR_PRICES: dict[str, float] = {
    ...
    "AAPL": 187.0, "PANW": 328.0, "SPY":  518.0, "SPCX": 160.0, "QQQ":  445.0,
